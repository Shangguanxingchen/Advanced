...
/* 11 */
/*!****************************************************************************************!*\
  !*** /Users/zhenghao/zh/KKB/wx-04/代码/12-美食收藏/main.js?{"page":"pages%2Findex%2Findex"} ***!
  \****************************************************************************************/
...
/* 12 */
/*!*********************************************************************!*\
  !*** /Users/zhenghao/zh/KKB/wx-04/代码/12-美食收藏/pages/index/index.vue ***!
  \*********************************************************************/
/*! no static exports found */
...
/* 13 */
/*!****************************************************************************************************!*\
  !*** /Users/zhenghao/zh/KKB/wx-04/代码/12-美食收藏/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \****************************************************************************************************/
...
/* 15 */
/*!**********************************************************************************************!*\
  !*** /Users/zhenghao/zh/KKB/wx-04/代码/12-美食收藏/pages/index/index.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...

{
  ...
  methods: {
      ...
      return new Promise(function (resolve) {
        uni.getSetting({
          success: function success(_ref) {var authSetting = _ref.authSetting;
            console.log('用户授权信息', authSetting);
            if (authSetting['scope.userInfo']) {
              uni.getUserInfo({
                success: function success(_ref2) {var userInfo = _ref2.userInfo;
    ...
    getOpenidByFn: function getOpenidByFn() {
      return new Promise(function (resolve, reject) {
        wx.cloud.callFunction({
          name: 'login',
          success: function success(_ref3) {var openid = _ref3.result.openid;
            resolve(openid);
          } });
    ...
    /**
        ...
        */
    analysis: function analysis(_ref4) {var latitude = _ref4.latitude,longitude = _ref4.longitude;
      console.log('analysis');
      return new Promise(function (resolve) {
        map.reverseGeocoder({
          location: { latitude: latitude, longitude: longitude },
          success: function success(_ref5) {var city = _ref5.result.address_component.city;
            console.log('反解析结果', city);
            resolve(city);
          } });
...
/* 18 */
/*!******************************************************************************************************!*\
  !*** /Users/zhenghao/zh/KKB/wx-04/代码/12-美食收藏/pages/index/index.vue?vue&type=style&index=0&lang=css& ***!
  \******************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
